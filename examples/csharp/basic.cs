...
{
    class LotteryNumberGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/lotterypicker";

        /// <summary>
        /// Make a GET request to the Lottery Number Generator API
        /// </summary>
        static async Task<JsonDocument> CallLotteryNumberGeneratorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;game&quot;] &#x3D; &quot;powerball&quot;, [&quot;numbers&quot;] &#x3D; 6, [&quot;max&quot;] &#x3D; 49, [&quot;bonus&quot;] &#x3D; 1, [&quot;tickets&quot;] &#x3D; 3 };
        ...
        {
            Console.WriteLine("📤 Calling Lottery Number Generator API...\n");

            var result = await CallLotteryNumberGeneratorAPI();
