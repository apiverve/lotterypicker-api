...
namespace APIVerve.API.LotteryNumberGenerator
{
    ...
    /// <summary>
    /// Client for the LotteryNumberGenerator API
    /// </summary>
    public class LotteryNumberGeneratorAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/lotterypicker";
        ...
        {
            { "game", new ValidationRule { Type = "string", Required = false } },
            { "numbers", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 20 } },
            { "max", new ValidationRule { Type = "integer", Required = false, Min = 10, Max = 100 } },
            { "bonus", new ValidationRule { Type = "integer", Required = false, Min = 0, Max = 5 } },
            { "tickets", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 25 } }
        };
        ...
        public LotteryNumberGeneratorAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public LotteryNumberGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public LotteryNumberGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, LotteryNumberGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(LotteryNumberGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(LotteryNumberGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(LotteryNumberGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(LotteryNumberGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(LotteryNumberGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(LotteryNumberGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(LotteryNumberGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(LotteryNumberGeneratorQueryOptions options)
        {
