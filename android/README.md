# Lottery Number Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:lotterypicker-api:1.1.14'
}
```
...
```java
import com.apiverve.lotterypicker.LotteryNumberGeneratorAPIClient;
import com.apiverve.lotterypicker.APIResponse;
import com.apiverve.lotterypicker.APIException;

// Initialize the client
LotteryNumberGeneratorAPIClient client = new LotteryNumberGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/lotterypicker](https://docs.apiverve.com/ref/lotterypicker)
...
- **Documentation:** [https://docs.apiverve.com/ref/lotterypicker](https://docs.apiverve.com/ref/lotterypicker)
- **Issues:** [GitHub Issues](https://github.com/apiverve/lotterypicker-api/issues)
