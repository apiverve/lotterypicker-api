...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/lotterypicker',
        'Source': 'https://github.com/apiverve/lotterypicker-api',
        'Bug Tracker': 'https://github.com/apiverve/lotterypicker-api/issues'
    },
    classifiers=[
