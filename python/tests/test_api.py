...
class TestLotterypickerAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = LotterypickerAPIClient(self.api_key)

    @patch('apiverve_lotterynumbergenerator.apiClient.requests.get')
