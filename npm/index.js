...
class lotterypickerWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/lotterypicker');
        }
        ...
        this.validationRules = {"game":{"type":"string","required":false,"default":"custom"},"numbers":{"type":"integer","required":false,"min":1,"max":20,"default":6},"max":{"type":"integer","required":false,"min":10,"max":100,"default":49},"bonus":{"type":"integer","required":false,"min":0,"max":5,"default":0},"tickets":{"type":"integer","required":false,"min":1,"max":25,"default":1}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/lotterypicker`);
        }
    }
...
module.exports = lotterypickerWrapper;
